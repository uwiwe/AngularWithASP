...
export class AppComponent {
  ...
  ngOnInit() { //Es para hacer algo con mi componente cuando ya esta renderizado
    this.http.get<Product[]>('https://api.escuelajs.co/api/v1/products') //Hacer una peticio, llamo a la api fake de platzi <Product[]> significa que va a recibir un array de Product
